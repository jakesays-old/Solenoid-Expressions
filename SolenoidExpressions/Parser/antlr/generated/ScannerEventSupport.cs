...
namespace Solenoid.Expressions.Parser.antlr.debug
{
	...
	public class ScannerEventSupport
	{
		...
		{
			var eventDelegate = (TokenEventHandler)((CharScanner)source).Events[Parser.LAEventKey];
		...
		{
			var eventDelegate = (TraceEventHandler)((CharScanner)source).Events[Parser.DoneEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			ruleDepth++;
			var eventDelegate = (TraceEventHandler)((CharScanner)source).Events[Parser.EnterRuleEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (TraceEventHandler)((CharScanner)source).Events[Parser.ExitRuleEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (MatchEventHandler)((CharScanner)source).Events[Parser.MatchNotEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (MatchEventHandler)((CharScanner)source).Events[Parser.MisMatchNotEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (NewLineEventHandler)((CharScanner)source).Events[Parser.NewLineEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (MessageEventHandler)((CharScanner)source).Events[Parser.ReportErrorEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (MessageEventHandler)((CharScanner)source).Events[Parser.ReportWarningEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (SemanticPredicateEventHandler)((CharScanner)source).Events[Parser.SemPredEvaluatedEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (SyntacticPredicateEventHandler)((CharScanner)source).Events[Parser.SynPredFailedEventKey];
			if (eventDelegate != null) 
			{
		...
		{
			var eventDelegate = (SyntacticPredicateEventHandler)((CharScanner)source).Events[Parser.SynPredStartedEventKey];
			if (eventDelegate != null) 
			{
				synPredEvent.setValues(0, guessing);
				eventDelegate(source, synPredEvent);
		...
		{
			var eventDelegate = (SyntacticPredicateEventHandler)((CharScanner)source).Events[Parser.SynPredSucceededEventKey];
			if (eventDelegate != null) 
			{
				synPredEvent.setValues(0, guessing);
				eventDelegate(source, synPredEvent);
