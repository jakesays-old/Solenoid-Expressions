...
namespace Solenoid.Expressions
{
	...
	public class MapEntryNode : BaseNode
	{
		...
		{
			var firstChild = (BaseNode) getFirstChild();
			var key = GetValue(firstChild, context, evalContext);
			var value = GetValue((BaseNode) firstChild.getNextSibling(), context, evalContext);
