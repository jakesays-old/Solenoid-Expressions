...
namespace Solenoid.Expressions.Support.Collections
{
	...
	///         <see cref="Solenoid.Expressions.Support.Collections.ISet" /> abstraction. The order of
	///         elements in a set is dependant on (a)the data-structure implementation, and
	///         (b)the implementation of the various
	///         <see cref="Solenoid.Expressions.Support.Collections.ISet" /> methods, and thus is not
	///         guaranteed.
	///     </p>
	///     <p>
	///         <see cref="Solenoid.Expressions.Support.Collections.ISet" /> overrides the
	...
	///         store collection objects inside <see cref="Solenoid.Expressions.Support.Collections.ISet" />
	///         instances. You would typically want to use a keyed
	///         <see cref="System.Collections.IDictionary" /> instead.
	///     </p>
	///     <p>
	///         None of the <see cref="Solenoid.Expressions.Support.Collections.ISet" /> implementations in
	///         this library are guaranteed to be thread-safe in any way.
	///     </p>
	///     <p>
	///         The following table summarizes the binary operators that are supported
	///         by the <see cref="Solenoid.Expressions.Support.Collections.ISet" /> class.
	///     </p>
	///     <list type="table">
	///         <listheader>
	///             <term>Operation</term>
	...
	public interface ISet : ICollection, ICloneable
	{
		...
		/// <returns>
		///     A new <see cref="ISet" /> containing the union of
		///     this <see cref="ISet" /> with the specified
		...
		///         <see cref="ISet" /> containing the elements from
		///         the operation.
		///     </p>
		/// </remarks>
		/// <param name="setOne">A set of elements.</param>
