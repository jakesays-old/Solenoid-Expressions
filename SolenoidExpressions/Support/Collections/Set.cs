...
namespace Solenoid.Expressions.Support.Collections
{
	...
	public abstract class Set : ISet
	{
		...
		/// <summary>
		///     Returns a clone of the <see cref="ISet" />
		///     instance.
		/// </summary>
		/// <remarks>
		///     <p>
		///         This will work for derived <see cref="ISet" />
		...
		{
			var newSet = (Set) Activator.CreateInstance(GetType());
			newSet.AddAll(this);
			return newSet;
		}
		...
		/// <summary>
		///     This method will test the <see cref="ISet" />
		///     against another <see cref="ISet" /> for
		///     "equality".
		/// </summary>
		/// <remarks>
		///     <p>
		...
		public override bool Equals(object obj)
		{
			...
			if (theOtherSet == null ||
				theOtherSet.Count != Count)
			{
				return false;
			}
			var result = theOtherSet.Cast<object>().All(Contains);
			return result;
		}
