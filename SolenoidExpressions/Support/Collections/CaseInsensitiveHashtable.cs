...
namespace Solenoid.Expressions.Support.Collections
{
	...
	public class CaseInsensitiveHashtable : Hashtable
	{
		...
		/// <summary>
		///     Implements the <see cref="ISerializable"></see> interface and returns the data needed to serialize the
		///     <see cref="CaseInsensitiveHashtable"></see>.
		/// </summary>
		/// <param name="context">
		///     A <see cref="StreamingContext"></see> object containing the source and destination of the
		///     serialized stream associated with the <see cref="CaseInsensitiveHashtable"></see>.
		/// </param>
		/// <param name="info">
		///     A <see cref="SerializationInfo"></see> object containing the information required to serialize the
		///     <see cref="CaseInsensitiveHashtable"></see>.
		/// </param>
		...
		protected override bool KeyEquals(object item, object key)
		{
			...
			return _culture.CompareInfo.Compare((string) item, (string) key, CompareOptions.IgnoreCase) == 0;
		}
