...
namespace Solenoid.Expressions.Support.Logging
{
    ...
    /// </para>
    /// <para>
    /// Each <see cref="ILog"/> log method offers to pass in a <see cref="System.Action{Solenoid.Expressions.Logging.FormatMessageHandler}(Solenoid.Expressions.Logging.FormatMessageHandler)"/> instead of the actual message.
    ...
    /// </code>
    /// </example>
    /// <seealso cref="System.Action{Solenoid.Expressions.Logging.FormatMessageHandler}(Solenoid.Expressions.Logging.FormatMessageHandler)"/>
