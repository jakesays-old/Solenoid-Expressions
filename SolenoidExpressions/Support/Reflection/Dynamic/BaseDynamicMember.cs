...
namespace Solenoid.Expressions.Support.Reflection.Dynamic
{
	...
	public class BaseDynamicMember
	{
		...
		/// </summary>
		protected const MethodAttributes DefaultMethodAttributes =
			MethodAttributes.Public | MethodAttributes.HideBySig
			| MethodAttributes.NewSlot | MethodAttributes.Virtual
			| MethodAttributes.Final;

		private static readonly ConstructorInfo _invalidOperationException =
		...
		protected static void ThrowInvalidOperationException(ILGenerator il, string message)
		{
			...
			il.Emit(OpCodes.Newobj, _invalidOperationException);
